...
export class OrderFlow1781861244110 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "autoConfirmed" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "preparationStartedAt" TIMESTAMP WITH TIME ZONE`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_0cf16cf1d67b273c7c34b494681" FOREIGN KEY ("confirmedById") REFERENCES "staff"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_303fee34b638662ba4d05392fa5" FOREIGN KEY ("cancelledById") REFERENCES "staff"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "FK_303fee34b638662ba4d05392fa5"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "FK_0cf16cf1d67b273c7c34b494681"`);
